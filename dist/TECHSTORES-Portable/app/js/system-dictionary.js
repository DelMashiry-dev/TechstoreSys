...
const SYSTEM_DICTIONARY_GROUPS = [
    ...
    },
    {
        ...
        terms: [
            ...
            { t: 'ICT equipment duty profile', d: 'Operational use for ICT equipment: laptops, desktops, workstations, tablets, printers, servers, field/rugged equipment, technical systems, or admin devices. Used in ICT Equipment Compare, Spec Search, and Duties & Roles.', w: 'ict-compare · spec-evaluation · duties-roles' },
            { t: 'ICT Equipment Compare', d: 'Workshop module: crawl the web for laptops, desktops, workstations, tablets, printers, or servers that match a duty profile, select two or more, and rank a best-buy using duty fit and listed price. Also searchable as Laptop Compare or Head-to-head compare. Previous searches are saved and recalled so the web is not crawled again unless you force refresh. Confirm a formal quote before F1.', w: 'ict-compare' },
            ...
            { t: 'Non-paid goods received', d: 'Supplier delivered, Army still owes. Tracked in Supplier Debts so IT Dir can push DAF for settlement. Age of debt counts from first supply date until paid.', w: 'supplier-debts' },
    ...
    },
    {
        ...
        terms: [
            ...
            { t: 'Supplier Debts / Non-paid goods received', d: 'Goods or services already delivered to the cost centre but not yet paid. DAF effects payment; IT Dir tracks how much each supplier is owed and the age of the debt so we can push DAF. Opposite of Undelivered Items.', w: 'supplier-debts' },
    ...
    },
    {
        ...
        terms: [
            ...
            { t: 'Supplier debt: Open / Chased DAF / Part paid / Paid', d: 'Non-paid goods received lifecycle. Age runs from first supply date until DAF pays.', w: 'supplier-debts' },
