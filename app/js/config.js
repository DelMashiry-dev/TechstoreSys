...
const MODULE_IDS = [
    ...
    'delivery-note', 'purchase-orders', 'undelivered-orders', 'supplier-debts', 'portals-board', 'stakeholder-desk', 'doc-import', 'workshop-receipt-cert', 'workshop-repairs', 'laptop-compare', 'ict-compare', 'gate-register', 'techstores-equipment-register', 'suppliers-contracts',
