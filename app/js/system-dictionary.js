...
const SYSTEM_DICTIONARY_GROUPS = [
    ...
    },
    {
        ...
        terms: [
            ...
            { t: 'Laptop Compare', d: 'Workshop module: rank laptops from the local ICT catalog and DP PO prices for a duty profile, brand, and minimum RAM/storage. Shows recommended buy, buy score ranking, and side-by-side specs. Switch Catalog (store cards), Showcase (OEM columns), or Table. Optionally add live market listings. Confirm a formal quote before F1.', w: 'laptop-compare' },
