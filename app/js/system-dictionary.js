...
const SYSTEM_DICTIONARY_GROUPS = [
    ...
    },
    {
        ...
        terms: [
            ...
            { t: 'Head-to-head compare', d: 'Workshop module: crawl the web for machines that match a duty profile, tick 2–4, and rank a best-buy (duty fit + listed price). Previous searches are saved and recalled so the web is not crawled again unless you force refresh. Confirm a formal quote before F1.', w: 'ict-compare' },
