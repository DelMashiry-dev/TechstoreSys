...
const SYSTEM_DICTIONARY_GROUPS = [
    ...
    },
    {
        ...
        terms: [
            ...
            { t: 'Laptop Compare', d: 'Workshop module: rank laptops from the local ICT catalog and DP PO prices for a duty profile, brand, and minimum RAM/storage. Shows recommended buy, buy score ranking, and side-by-side specs. Switch Showcase (OEM photo columns) or Table. Optionally add live market listings. Confirm a formal quote before F1.', w: 'laptop-compare' },
            { t: 'H2H ICT Comparison', d: 'Workshop head-to-head compare: crawl web listings by duty profile and equipment type (laptop, desktop, server, tablet, printer). Select two or more candidates, then switch Showcase or Table. Saved search history avoids repeat crawls.', w: 'ict-compare' },
