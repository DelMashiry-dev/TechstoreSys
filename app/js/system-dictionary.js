...
const SYSTEM_DICTIONARY_GROUPS = [
    ...
    },
    {
        ...
        terms: [
            ...
            { t: 'ICT Equip Compare', d: 'Workshop module: compare laptops, desktops, servers, printers, tablets, network or other ICT from the local catalog (pick by name or rank by duty). Optional web-crawl enrich and AI buy recommendation. Shows recommended buy, buy score ranking, and side-by-side specs. Confirm a formal quote before F1. (H2H ICT Comparison remains available for web-crawl candidate grids.)', w: 'laptop-compare' },
            { t: 'Laptop Compare', d: 'See ICT Equip Compare — same module; now covers all ICT equipment types, not only laptops.', w: 'laptop-compare' },
            { t: 'H2H ICT Comparison', d: 'Workshop head-to-head compare: crawl web listings by duty profile and equipment type (laptop, desktop, server, tablet, printer). Select two or more candidates, then switch Catalog, Showcase, or Table. Saved search history avoids repeat crawls.', w: 'ict-compare' },
    ...
    },
    {
        ...
        terms: [
            ...
            { t: 'Smart Ops Desk', d: 'Cross-module intelligence: project DAF buying power, prioritise Creditors and Undelivered, suggest next actions, optional AI ops brief. See docs/INTELLIGENCE-ROADMAP.md for PO intellisense and demand forecast phases.', w: 'smart-ops-desk' },
            ...
            { t: 'Appearance', d: 'Header control for theme (including Color Parade), layout density, button size (Small / Medium / Big) and field size (Small / Narrow / Medium / Big). Saved with your system data.', w: 'Header · Appearance' },
...
const DICT_NAV_ALIASES = {
    ...
    'smart-ops-desk': 'smart-ops-desk',
    'smart ops': 'smart-ops-desk',
    'ops desk': 'smart-ops-desk',
    'intelligence': 'smart-ops-desk',
