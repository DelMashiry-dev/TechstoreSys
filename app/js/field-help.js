...
const FIELD_HELP = {
    ...
    'orderly room': { title: 'Orderly Room (DF)', body: 'IT Dir Orderly Room Daily File / First Sight. Unit requisitions arrive as GS Branch loose minutes and are booked here, then appear in the TechStores in-tray.' },
    'daily file': { title: 'Daily File (DF)', body: 'Orderly Room file — first sight of incoming correspondence. GS Branch loose minutes (unit ICT requests) are placed here so HoDs and TechStores see them the same day.' },
    'first sight': { title: 'First Sight', body: 'Immediate Orderly Room booking of incoming paper (including GS Branch loose minutes) so commanders / HoDs see it before deeper filing.' },
    'gs branch': { title: 'GS Branch', body: 'General Staff Branch. Unit ICT requisitions come through GS Branch as loose minutes (Action: Brig Gen GS · Info: Col SD, IT Dir) before IT Dir files them First Sight / DF.' },
    'loose minute': { title: 'Loose Minute', body: 'The paper form of a unit requisition. Routed through GS Branch to IT Dir. Booked in the Requisitions First Sight / DF in-tray.' },
