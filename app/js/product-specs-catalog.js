...
const PRODUCT_SPECS_CATALOG = [
    ...
    },
    {
        ...
        specs: [
            ...
            ['Memory', '32 GB RAM', 'Heavy multitasking'],
            ['RAM', '32 GB RAM', 'Heavy multitasking'],
            ['Storage', '1 TB SSD', 'Local project and media store'],
            ['Keyboard', 'Full-size 4-zone RGB backlight keyboard with numeric keypad', 'Gaming typing'],
            ['Pointing Device', 'HP Imagepad with multi-gesture support', 'Precision touchpad'],
            ['WebCam', 'HP Wide Vision 1080p FHD camera with temporal noise reduction and dual-array mics', 'Video calls'],
            ['Battery', '6-cell, 83 Wh Lithium-Ion (Li-ion) polymer battery', 'Extended session class'],
            ['Ports', 'USB Type-C (DisplayPort / Power Delivery), USB Type-A, HDMI 2.1, RJ-45, headphone/mic combo (confirm SKU)', 'I/O'],
            ['Security', 'TPM 2.0', 'Baseline'],
    ...
    },
    {
        ...
        aliases: ['victus', 'victus 15', 'victus gaming', 'hp victus'],
        dutyProfiles: ['simulations', 'graphic-design', 'programming', 'software-engineering'],
        specs: [
            ['Device Type', '15.6\" gaming / student performance laptop', 'Value gaming class'],
            ['Model', 'Victus Gaming Laptop 15 (confirm exact SKU)', 'Victus 15 series'],
            ['Processor', 'Intel Core i5 / i7 or AMD Ryzen 5 / 7 options', 'Confirm on supplier quote'],
            ['Graphics', 'NVIDIA GeForce RTX 4050 / 4060 class (config dependent)', 'GPU workloads'],
            ['Operating System', 'Windows 11 Home / Pro (config)', 'Confirm Pro for domain join'],
            ['Display', '15.6\" FHD (1920 × 1080), 144 Hz IPS typical', 'Smooth visuals'],
            ['Memory', '16 GB DDR4/DDR5 (expandable on many SKUs)', 'Multitasking'],
            ['RAM', '16 GB DDR4/DDR5 (expandable on many SKUs)', 'Multitasking'],
            ['Storage', '512 GB NVMe SSD typical', 'Fast local store'],
            ['Keyboard', 'Full-size island-style with numeric keypad; single-zone backlight (config)', 'Desktop-like typing'],
            ['Pointing Device', 'HP Imagepad with multi-gesture support', 'Precision touchpad'],
            ['WebCam', 'HP True Vision 720p HD camera with dual-array digital microphones', 'Video calls'],
            ['Battery', '3-cell, 52.5 Wh Lithium-Ion (Li-ion) polymer battery (typical Victus 15; confirm SKU)', 'Mobility'],
            ['Ports', '1× USB Type-C, 2× USB Type-A, 1× HDMI 2.1, 1× RJ-45, headphone/mic combo, SD media card reader (config dependent)', 'I/O'],
            ['Security', 'TPM 2.0', 'Baseline'],
            ['Warranty', '1 year HP limited warranty (confirm contract)', 'Service continuity']
        ]
    },
    {
        ...
        aliases: ['omen transcend', 'transcend 14', 'omen transcend 14', 'hp transcend'],
        dutyProfiles: ['simulations', 'graphic-design', 'machine-learning', 'software-engineering', 'architecture'],
        specs: [
            ['Device Type', '14\" thin high-performance / creator laptop', 'Portable GPU class'],
            ['Model', 'OMEN Transcend 14 (confirm exact SKU)', 'OMEN Transcend 14 series'],
            ['Processor', 'Intel Core Ultra / AMD Ryzen AI options', 'On-device AI + performance'],
            ['Graphics', 'NVIDIA GeForce RTX 4050 / 4060 / 4070 class (config)', 'Design and simulation'],
            ['Operating System', 'Windows 11 Home / Pro (config)', 'Confirm Pro for domain join'],
            ['Display', '14\" OLED / high-res touch options (config)', 'Colour-critical work'],
            ['Memory', '16–32 GB LPDDR5x typical (soldered on many SKUs)', 'Heavy multitasking'],
            ['RAM', '16–32 GB LPDDR5x typical (soldered on many SKUs)', 'Heavy multitasking'],
            ['Storage', '1 TB NVMe SSD typical', 'Local media and projects'],
            ['Keyboard', 'Full-size chiclet keyboard with RGB / white backlight (config)', 'Compact gaming typing'],
            ['Pointing Device', 'Precision clickpad with multi-gesture support', 'Touchpad'],
            ['WebCam', 'FHD / IR camera options with temporal noise reduction and dual-array mics (config)', 'Video calls / Windows Hello where fitted'],
            ['Battery', '4-cell / 6-cell class Lithium-Ion (Li-ion) polymer battery — capacity SKU-dependent (often ~70–83 Wh class; confirm datasheet)', 'Thin-chassis mobility'],
            ['Ports', 'Thunderbolt / USB4 Type-C, USB Type-A, HDMI, headphone/mic combo, microSD (config dependent)', 'I/O'],
            ['Security', 'TPM 2.0; fingerprint / IR camera options (config)', 'Baseline'],
            ['Warranty', '1 year HP limited warranty (confirm contract)', 'Service continuity']
        ]
    },
    {
        id: 'hp-omen-16-am0000ne',
        brand: 'HP',
        model: 'OMEN 16 Gaming Laptop (16-am0000ne)',
        category: 'laptop',
        names: [
            'HP OMEN 16 Gaming Laptop (16-am0000ne)',
            'HP OMEN 16-am0000ne',
            'OMEN 16-am0000ne',
            'OMEN 16'
        ],
        aliases: ['omen 16 am0000ne', '16-am0000ne', 'am0000ne', 'omen 16'],
        dutyProfiles: ['simulations', 'graphic-design', 'machine-learning', 'software-engineering'],
        specs: [
            ['Device Type', '16\" gaming / high-performance laptop', 'ICT Equipment stock line'],
            ['Model', '16-am0000ne', 'OMEN 16 series'],
            ['Processor', 'AMD Ryzen / Intel Core high-end options', 'Confirm on quotation'],
            ['Graphics', 'NVIDIA GeForce RTX class discrete GPU', 'GPU workloads'],
            ['Operating System', 'Windows 11 Home / Pro (config)', 'Confirm Pro if required'],
            ['Display', '16\" FHD / QHD high-refresh IPS (config)', 'Design and briefings'],
            ['Memory', '16–32 GB DDR5 typical', 'Heavy multitasking'],
            ['RAM', '16–32 GB DDR5 typical', 'Heavy multitasking'],
            ['Storage', '512 GB–1 TB NVMe SSD typical', 'Local project store'],
            ['Keyboard', 'Full-size 4-zone / single-zone RGB backlight keyboard with numeric keypad (config)', 'Gaming typing'],
            ['Pointing Device', 'HP Imagepad with multi-gesture support', 'Precision touchpad'],
            ['WebCam', 'HP Wide Vision 1080p FHD camera with temporal noise reduction and dual-array mics (config)', 'Video calls'],
            ['Battery', '6-cell, 83 Wh Lithium-Ion (Li-ion) polymer battery (typical OMEN 16; confirm SKU)', 'Extended session class'],
            ['Ports', '1× USB Type-C (DisplayPort / Power Delivery), USB Type-A, HDMI 2.1, RJ-45, headphone/mic combo, mini DisplayPort (config dependent)', 'I/O'],
            ['Security', 'TPM 2.0', 'Baseline'],
            ['Warranty', '1 year HP limited warranty (confirm contract)', 'Service continuity']
        ]
    },
